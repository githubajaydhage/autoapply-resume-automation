...
class RecruiterNameFinder:
    ...
    def get_greeting(self, email: str, company: str) -> str:
        """Always return Hiring Team greeting - no name extraction to avoid errors."""
        # ALWAYS use Hiring Team - consistent and professional
...
class EmailOptimizer:
    ...
    def generate_optimized_body(self,
        ...
        # ALWAYS use Hiring Team greeting - no name personalization to avoid errors
